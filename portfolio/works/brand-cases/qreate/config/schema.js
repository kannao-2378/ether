export const moduleSchema = [
  {
    ...
    description: '案例章节导航',
    content: [
      { key: 'role', label: '角色诠释', selector: '.nav__item:nth-child(1)' },
      { key: 'comparison', label: '效果对比', selector: '.nav__item:nth-child(2)' },
      { key: 'method', label: '方法论', selector: '.nav__item:nth-child(3)' },
      { key: 'moreCases', label: '更多案例', selector: '.nav__item:nth-child(4)' },
      { key: 'tools', label: '工具支撑', selector: '.nav__item:nth-child(5)' },
      { key: 'ai', label: 'AI嵌入', selector: '.nav__item:nth-child(6)' },
      { key: 'render', label: '渲染配合', selector: '.nav__item:nth-child(7)' },
      { key: 'motion', label: '动态展示', selector: '.nav__item:nth-child(8)' },
      { key: 'contact', label: '联系方式', selector: '.nav__item:nth-child(9)' }
    ],
    motion: []
  },
  {
